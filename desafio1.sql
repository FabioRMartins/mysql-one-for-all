...
CREATE TABLE SpotifyClone.historico_de_reproducao(
    ...
    PRIMARY KEY (data_reproducao, usuario_id, cancao_id)
) engine = InnoDB;

INSERT INTO SpotifyClone.planos (id, plano, valor_plano)
VALUES
  ('1', 'gratuito', '0'),
  ('2',	'familiar',	'7.99'),
...
INSERT INTO SpotifyClone.usuarios (plano_id, usuario, idade, data_assinatura)
VALUES
...
INSERT INTO SpotifyClone.historico_de_reproducao (data_reproducao, usuario_id, cancao_id)
VALUES
